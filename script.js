...
const products = [
    ...
    { id: 10, name: "Handloom Lungi", price: 599, image: "https://i.ibb.co/0BrQn3L/Screenshot-2026-07-05-14-30-22-88-2c94496c64eeaa7ef093c298145d7980.jpg" }
];

// =====================
// EMAIL SETUP (FORMPREE)
// =====================
const YOUR_EMAIL_FORM_ID = "xeebnekq"; // ✅ Formspree Form ID
...
// =====================
// CHECKOUT + EMAIL (WITH PRODUCTS + IMAGES)
// =====================
function checkout() {
    if (cart.length === 0) {
        alert('Cart is empty');
...
if (orderForm) {
    orderForm.addEventListener('submit', function(e) {
        ...
        // ===== EMAIL NOTIFICATION (WITH PRODUCTS + IMAGES) =====
