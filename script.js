// ============================================
// 📦 PRODUCTS DATA (LocalStorage ke saath - Permanent)
// ============================================
let products = JSON.parse(localStorage.getItem('arariaProducts')) || [
    {
        name: "Shirt White",
        price: 299,
        detail: "Size: M, L, XL",
...
function saveProducts() {
    localStorage.setItem('arariaProducts', JSON.stringify(products));
}
...
// ============================================
// 🆕 ADD PRODUCT - NECHE (With LocalStorage Save)
// ============================================
